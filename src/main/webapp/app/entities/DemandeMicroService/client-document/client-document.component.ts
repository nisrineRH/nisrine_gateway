...
export class Client_documentComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.client_documentService
            ...
            .subscribe(
                (res: HttpResponse<IClient_document[]>) => this.paginateClient_documents(res.body, res.headers),
    ...
    ngOnInit() {
        ...
        this.registerChangeInClient_documents();
    }
    ...
    trackId(index: number, item: IClient_document) {
        return item.id;
    }

    registerChangeInClient_documents() {
        this.eventSubscriber = this.eventManager.subscribe('client_documentListModification', response => this.loadAll());
    }
    ...
    protected paginateClient_documents(data: IClient_document[], headers: HttpHeaders) {
